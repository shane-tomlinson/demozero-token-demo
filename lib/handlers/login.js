...
const authenticate = (req, res) => {
  ...
  if (req.body.send_authorization_details) {
    authorizationDetails = {
      authorization_details: req.body.authorization_details,
    };
  }
  authorizeUrl.query = getAuthorizeParams(req, authorizationDetails);
...
const authenticateWithPar = async (req, res) => {
  ...
  let authorizationDetails = {};
  if (req.body.send_authorization_details_par) {
    authorizationDetails = {
      authorization_details: req.body.authorization_details,
    };
  }
  ...
  try {
    response = await axios.post(
      ...
      querystring.stringify({
        ...getAuthorizeParams(req, authorizationDetails),
...
module.exports = {
  authenticate,
  authenticateWithPar,
  authenticateWithRar: authenticate,
  orgSelection,
  getOrganizations,
  getRoles,
  getConnections,
