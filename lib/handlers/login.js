...
const { getAppClientAuthentication } = require("../client_authentication");
...
const authenticate = (req, res) => {
  ...
  console.log(`Calling ${AUTHORIZE_ENDPOINT} with ${JSON.stringify(authorizeUrl.query)}`);
